...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 284, 78))
...
"}")
        ...
        self.rabi_step_spbx.setProperty("value", 5)
        ...
        self.rabi_stop_spbx.setMaximum(1000000000)
        ...
        self.rabi_start_spbx.setMaximum(1000000000)
        self.rabi_start_spbx.setProperty("value", 0)
        ...
        self.laser_time_spbx.setProperty("value", 5)
        ...
        self.wait_time_spbx.setMaximum(50000)
        self.wait_time_spbx.setProperty("value", 10000)
        ...
        self.laser_delay_spbx.setProperty("value", 300)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 602, 69))
        ...
        self.rabi_data_type_cbx = QtWidgets.QComboBox(self.groupBox_9)
        self.rabi_data_type_cbx.setObjectName("rabi_data_type_cbx")
        self.rabi_data_type_cbx.addItem("")
        self.rabi_data_type_cbx.addItem("")
        self.rabi_data_type_cbx.addItem("")
        self.rabi_data_type_cbx.addItem("")
        self.horizontalLayout_3.addWidget(self.rabi_data_type_cbx)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem3)
        self.generate_rabi_btn = QtWidgets.QPushButton(self.groupBox_9)
        self.generate_rabi_btn.setIcon(icon3)
        self.generate_rabi_btn.setIconSize(QtCore.QSize(20, 25))
        self.generate_rabi_btn.setObjectName("generate_rabi_btn")
        self.horizontalLayout_3.addWidget(self.generate_rabi_btn)
        ...
        self.signal_start_spbx = QtWidgets.QSpinBox(self.groupBox_9)
        self.signal_start_spbx.setMaximum(10000)
        self.signal_start_spbx.setProperty("value", 0)
        self.signal_start_spbx.setObjectName("signal_start_spbx")
        self.gridLayout.addWidget(self.signal_start_spbx, 0, 1, 1, 1)
        ...
        self.ref_start_spbx = QtWidgets.QSpinBox(self.groupBox_9)
        self.ref_start_spbx.setMaximum(10000)
        self.ref_start_spbx.setProperty("value", 2500)
        self.ref_start_spbx.setObjectName("ref_start_spbx")
        self.gridLayout.addWidget(self.ref_start_spbx, 2, 1, 1, 1)
        self.signal_span_spbx = QtWidgets.QSpinBox(self.groupBox_9)
        self.signal_span_spbx.setMaximum(10000)
        self.signal_span_spbx.setProperty("value", 500)
        self.signal_span_spbx.setObjectName("signal_span_spbx")
        self.gridLayout.addWidget(self.signal_span_spbx, 0, 3, 1, 1)
        self.ref_span_spbx = QtWidgets.QSpinBox(self.groupBox_9)
        self.ref_span_spbx.setMaximum(10000)
        self.ref_span_spbx.setProperty("value", 500)
        self.ref_span_spbx.setObjectName("ref_span_spbx")
        self.gridLayout.addWidget(self.ref_span_spbx, 2, 3, 1, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 929, 69))
    ...
    def retranslateUi(self, Form):
        ...
        self.bin_width_cbx.setItemText(0, _translate("Form", "10"))
        self.bin_width_cbx.setItemText(1, _translate("Form", "1"))
        self.bin_width_cbx.setItemText(2, _translate("Form", "2"))
        self.bin_width_cbx.setItemText(3, _translate("Form", "4"))
        ...
        self.rabi_data_type_cbx.setItemText(0, _translate("Form", "sum"))
        self.rabi_data_type_cbx.setItemText(1, _translate("Form", "mean"))
        self.rabi_data_type_cbx.setItemText(2, _translate("Form", "reference"))
        self.rabi_data_type_cbx.setItemText(3, _translate("Form", "mean_norm"))
        self.generate_rabi_btn.setText(_translate("Form", "Regenerate"))
